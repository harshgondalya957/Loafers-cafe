...
const SavouriesCard = ({ image, name, description, price, onAdd }) => {
    return (
        <motion.div
        ...
        >
            ...
            <div className="relative w-full h-56 md:w-44 md:h-[200px] flex-shrink-0 flex flex-col justify-center">
                <img
                    src={image}
                    alt={name}

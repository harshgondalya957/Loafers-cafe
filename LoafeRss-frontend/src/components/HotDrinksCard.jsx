...
const HotDrinksCard = ({ image, name, price, onAdd }) => {
    return (
        <motion.div
        ...
        >
            ...
            <div className="flex flex-col justify-center gap-1 h-full p-4 flex-1">
                <h3 className="font-heading font-bold text-gray-800 text-lg leading-tight group-hover:text-primary transition-colors">
                    {name}
                </h3>
